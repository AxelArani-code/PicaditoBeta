    ...
    <div className="min-h-screen bg-background text-text-primary">
      ...
      <main className="mx-auto max-w-7xl px-4 py-28 sm:px-6">
        <section className="rounded-[2rem] border border-white/10 bg-[#08110a]/90 p-10 shadow-[0_25px_80px_-50px_rgba(0,255,147,0.25)]">
          <h1 className="text-4xl font-black text-white sm:text-5xl">Reserva tu cancha</h1>
          <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-300 sm:text-base">
            Explora las mejores canchas disponibles, elige tu horario y confirma tu reserva en segundos.
          </p>
        </section>
      </main>
      <Footer />
