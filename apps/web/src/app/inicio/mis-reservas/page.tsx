...
// ─────────────────────────────────────────────────────────────────────────────
// app/inicio/mis-reservas/page.tsx
// "Mis Reservas" — Player view inside the public player shell (/inicio)
// Components live in (dashboard)/dashboard/mis-reservas/components/ and are
// shared from there. Only this page file defines the route.
// ─────────────────────────────────────────────────────────────────────────────
...
function BookingCardSkeleton() {
  return (
    <div className="flex h-40 animate-pulse overflow-hidden rounded-2xl border border-[#1a2e3a] bg-[#0b1a25]">
...
// ── Inner content (needs to be client) ───────────────────────────────────────
function MisReservasContent() {
  ...
  // Derive venue options from loaded bookings
...
// ── Page export — wraps content in PublicShell ────────────────────────────────
