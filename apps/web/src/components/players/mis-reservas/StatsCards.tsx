// ─────────────────────────────────────────────────────────────────────────────
// components/players/mis-reservas/StatsCards.tsx
// 4 summary cards for "Mis Reservas" header
// ─────────────────────────────────────────────────────────────────────────────
...
export function StatsCards({ stats, loading }: StatsCardsProps) {
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
      <StatCard label="Total Reservas" value={stats.total}     color="text-white"        loading={loading} />
      <StatCard label="Confirmadas"    value={stats.confirmed} color="text-[#4be176]"    loading={loading} />
      <StatCard label="Pendientes"     value={stats.pending}   color="text-[#fbbf24]"    loading={loading} />
      <StatCard label="Canceladas"     value={stats.cancelled} color="text-[#ef4444]"    loading={loading} />
    </div>
  );
}
